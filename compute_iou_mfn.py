...
def compute_mIoU(gt_dir, pred_dir, devkit_dir=''):
    ...
    #  info = json.load(fp)
    num_classes = 4
    name_classes = ['unlabeled', 'car', 'person', 'bicycle']
    mapping = {0:0, 1:1, 2:2, 3:3, 4:0, 5:0, 6:0, 7:0, 8:0}
    hist = np.zeros((num_classes, num_classes))

    image_path_list = join(devkit_dir, 'label.txt')
...
if __name__ == "__main__":
    ...
    args.gt_dir = '../thermal-uda/dataset_dir/mfn/annotations/training/'
    args.pred_dir = './result/mfn/'
    args.devkit_dir = '../thermal-uda/dataset_dir/mfn_list/'
    main(args)
